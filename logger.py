...
class Logger:
    ...
    def visualize_rec(self, inp, out):
        image = self.visualizer.visualize(inp['driving'][0:1,:,:,:], inp['source'][0:1,:,:,:], out[0:1,:,:,:])
...
class Visualizer:
    ...
    def visualize(self, driving, source, out,animate=False):
        images = []
        ...
        if 'mask' in out:
            ...
            for i in range(mask_map.shape[1]):
                ...
                # if i > 0:
                    # images.append((mask_i,kp_driving[:,i-1:i,:]))
                # else:
                #     images.append(mask_i)
