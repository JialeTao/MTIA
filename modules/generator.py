...
class OcclusionAwareGenerator(nn.Module):
    ...
    def __init__(self, num_channels, num_kp, block_expansion, max_features, num_down_blocks,
                 num_bottleneck_blocks, estimate_occlusion_map=False, dense_motion_params=None, estimate_jacobian=False,skips=False):
    ...
    def forward(self, source_image, kp_driving, kp_source, driving_image=None, bg_params=None, epoch=100):
        ...
        if self.dense_motion_network is not None:
            dense_motion = self.dense_motion_network(source_image=source_image, kp_driving=kp_driving, kp_source=kp_source, bg_params=bg_params)
            deformation = dense_motion['deformation']
            output_dict['mask'] = dense_motion['mask']
            output_dict['logit_mask'] = dense_motion['logit_mask']
