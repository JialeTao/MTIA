...
# import timm
import math
from .tokenpose_base import TokenPoseEncoderDecoder
...
class TokenPose_B(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.transformer = TokenPoseEncoderDecoder(feature_size=[cfg.MODEL.IMAGE_SIZE[1]//4,cfg.MODEL.IMAGE_SIZE[0]//4],patch_size=[cfg.MODEL.PATCH_SIZE[1],cfg.MODEL.PATCH_SIZE[0]],
                                 num_keypoints = cfg.MODEL.NUM_JOINTS,dim =cfg.MODEL.DIM,
                                 channels=cfg.MODEL.BASE_CHANNEL,
                                 depth_encoder=cfg.MODEL.TRANSFORMER_DEPTH_ENCODER,depth_decoder=cfg.MODEL.TRANSFORMER_DEPTH_DECODER,heads=cfg.MODEL.TRANSFORMER_HEADS,
                                 ...
                                 memory_v_pos=cfg.MODEL.MEMORY_V_POS)
        ###################################################3
