...
# import timm
import math
from .tokenpose_base import TokenPoseEncoder
...
class TokenPose_B(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.transformer = TokenPoseEncoder(feature_size=[cfg.MODEL.IMAGE_SIZE[1]//4,cfg.MODEL.IMAGE_SIZE[0]//4],patch_size=[cfg.MODEL.PATCH_SIZE[1],cfg.MODEL.PATCH_SIZE[0]],
